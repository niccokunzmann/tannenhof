{{{include('top.html.t')}}}
					...
					<div class="impressum">J&ouml;rg Kunzmann</div>
					...
					<div class="impressum">
						...
						Treten mit der Webseite Probleme auf, können sie es
...
{{{include('helper/umgebung.html.t')}}}
					...
					<div class="impressum">
						...
						<div class="quelle">
							{{{floatLink(	"https://commons.wikimedia.org/wiki/File:Panoramapark_Rodel.jpg",	
											"http://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Panoramapark_Rodel.jpg/220px-Panoramapark_Rodel.jpg", 
											u"Sommerrodelbahn")}}} 
							by <a href="https://commons.wikimedia.org/wiki/User:Sarion">Stefan Scheer</a>
						</div>
					</div>
